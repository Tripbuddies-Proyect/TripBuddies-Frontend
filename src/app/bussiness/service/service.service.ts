...
export class ServiceService {
  baseURL = "https://tripbuddies-backend-production.up.railway.app/api/v1/Carrier";
  PlaceByBussinessID = "https://tripbuddies-backend-production.up.railway.app/api/v1/places/bussiness";
  ...
  PaymentURL = "https://tripbuddies-backend-production.up.railway.app/api/v1/Payment";
  ...
  GetContacts(userId: number): Observable<Object>{
    return this.http.get<Object>(`https://tripbuddies-backend-production.up.railway.app/api/v1/users/${userId}/messages/LastMessageBussiness`, this.httpOptions).
